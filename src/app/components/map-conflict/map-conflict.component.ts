...
import { BarChartModel, ScatterPlotModel } from "@arcgis/charts-model";
...
@Component({
  ...
  templateUrl: "./map-conflict.component.html",
  styleUrl: "./map-conflict.component.css",
})
export class MapConflictComponent {
  @Input() mapId: string = "";
  ...
  async createScatterPlot() {
    ...
    featureLayer = await loadFeatureLayer("0ed2adbeb476430e969d5bc4261eaf06");
    ...
    barChartModel.numericFields = ["Protests", "Riots"];
